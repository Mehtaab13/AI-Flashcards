...
export default function Generate(){
    ...
    return (
        <Container maxWidth="md" sx={{ backgroundColor: "#1e1e1e", minHeight: "100vh", color: "#c5c6c7" }}>
            <Box
                sx={{
                    mt:4,
                    mb: 6, 
            ...
            {flashcards.length > 0 && (
                <Box sx={{mt: 4}}>
                    <Typography variant = 'h5' sx={{ fontFamily: "monospace", mb: 4 }}>
                        Flashcards Preview
                    </Typography>
                    ...
                    <Box sx={{mt: 4, display: 'flex', justifyContent: 'center'}}>
                        <Button variant='contained' sx={{ backgroundColor: "#61dafb", color: "#1e1e1e" }} onClick={handleOpen}>
                            Save
                        </Button>
                    </Box>
                </Box>
            ...
            <Dialog open={open} onClose={handleClose}>
                <DialogTitle sx={{ backgroundColor: "#282c34", color: "#c5c6c7" }}>Save Flashcards</DialogTitle>
                <DialogContent sx={{ backgroundColor: "#282c34", color: "#c5c6c7" }}>
                ...
                <DialogActions sx={{ backgroundColor: "#282c34" }}>
                    ...
                    <Button onClick={saveFlashcards} sx={{ backgroundColor: "#61dafb", color: "#1e1e1e" }}>
                        Save
                    </Button>
                </DialogActions>
            </Dialog>
